...
(() => {
  ...
  function a(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : l(t[s]) && l(e[s]) && Object.keys(t[s]).length > 0 && a(e[s], t[s]);
    });
  }
  const d = {
    body: {},
          ...
          void 0 !== r &&
            ...
            (x(e[n]) && x(i[n])
              ? i[n].__swiper__
                ...
                : I(e[n], i[n])
              : !x(e[n]) && x(i[n])
              ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : I(e[n], i[n]))
              : (e[n] = i[n]));
        }
      }
    }
  ...
  const N = {
    loopCreate: function () {
      ...
      for (let e = o.length - 1; e >= 0; e -= 1)
        n.prepend(w(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  function q(e) {
    ...
    if (!s.allowTouchMove)
      return (
        w(a.target).is(i.focusableElements) || (s.allowClick = !1),
        void (
          i.isTouched &&
    ...
    if (
      ...
      w(a.target).is(i.focusableElements)
    )
  ...
  const J = {
    setBreakpoint: function () {
      ...
      u && s && e.changeDirection(), I(e.params, a);
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: r } = t.navigation,
          o = s.target;
        if (t.params.navigation.hideOnClick && !w(o).is(r) && !w(o).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function de(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(ae(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          r.find(ae(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function u() {
      ...
      0 !== s.length &&
        (t.params.uniqueNavElements &&
          ...
          ((s = t.$el.find(e.el)),
          s.length > 1 &&
            (s = s.filter((e) => w(e).parents(".swiper")[0] === t.el))),
        ...
        e.clickable &&
          s.on("click", ae(e.bulletClass), function (e) {
            e.preventDefault();
            let s = w(this).index() * t.params.slidesPerGroup;
  ...
  var Be = function (e, t, s, i) {
      void 0 === s && (s = 0);
      var n = $e(e).attr("data-lg-size") || i;
      if (n) {
        var r = n.split(",");
        if (r[1])
    ...
    Ge = function (e, t, s, i, n) {
      if (n) {
        var r = $e(e).find("img").first();
        if (r.get()) {
    ...
    Xe = (function () {
      ...
      return (
        ...
        (e.prototype.openGallery = function (e, t) {
          ...
          if ((void 0 === e && (e = this.settings.index), !this.lgOpened)) {
            ...
            this.zoomFromOrigin &&
              ...
              (r = Ge(t, this.outer, l, a, this.currentImageSize))),
        ...
        (e.prototype.getDummyImageContent = function (e, t, s) {
          var i;
          if ((this.settings.dynamic || (i = $e(this.items).eq(t)), i)) {
            var n = void 0;
            if (
        ...
        (e.prototype.loadContent = function (e, t) {
          ...
          if (
            ...
            if (m) {
              ...
              S = Ve(r, T || "", g, this.settings.strings.playVideo, h);
              n.prepend(S);
            } else if (h) {
        ...
        (e.prototype.enableDrag = function () {
          ...
          this.settings.enableDrag &&
            ...
            $e(window).on("mousemove.lg.global" + this.lgId, function (r) {
              i &&
                e.lgOpened &&
                ((n = !0),
            ...
            $e(window).on("mouseup.lg.global" + this.lgId, function (r) {
              if (e.lgOpened) {
                var o = $e(r.target);
                n
        ...
        (e.prototype.closeGallery = function (e) {
          ...
          this.LGel.trigger(_e), $e(window).scrollTop(this.prevScrollTop);
          var s,
          ...
          (n.style.cssText = `\n\t\tleft: ${d}px;\n\t\ttop: ${c}px;\n\t\twidth: 0px;\n\t\theight: 0px;\n\t\topacity: 0; \n\t\t`),
            n.addEventListener("transitionend", () => {
              e.classList.contains("_fly") &&
                (n.remove(), Ze(e, t), e.classList.remove("_fly"));
            });
        }
      })(t, e);
    }
